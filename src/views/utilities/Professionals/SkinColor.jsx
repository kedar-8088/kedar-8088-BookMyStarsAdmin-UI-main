...
import { fetchSkinColors, addSkinColor, deleteSkinColor, getSkinColorById, updateSkinColor, getSkinColorCount } from 'views/API/SkinColorApi';
                                ...
                                <TableRow hover role="checkbox" tabIndex={-1} key={row.skinColorId}>
                                    {columns.map((column) => (
                                        <TableCell key={column.id} align={column.align}>
                                            {column.id === 'actions' ? (
                                                <>
                                                    <IconButton onClick={() => handleEdit(row.skinColorId)} style={{ color: '#00afb5' }}>
                                                        <Edit />
                                                    </IconButton>
                                                    <IconButton onClick={() => handleDelete(row.skinColorId)} color="error">
                                                        <DeleteForever />
                                                    </IconButton>
                                                </>
                                            ) : column.id === 'isActive' ? (
                ...
                title={
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                            <span>Skin Color Management</span>
