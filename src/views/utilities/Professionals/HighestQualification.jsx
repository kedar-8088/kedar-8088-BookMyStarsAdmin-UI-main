                            ...
                            <TableRow>
                                <TableCell colSpan={columns.length} align="center">
                                    <Box sx={{ py: 2 }}>
                                        ...
                                        <div style={{ fontSize: '12px', color: 'gray' }}>Highest qualifications array length: {highestQualifications.length}</div>
                                    </Box>
                                </TableCell>
                            </TableRow>
                        ) : (
                                ...
                                <TableRow hover role="checkbox" tabIndex={-1} key={row.highestQualificationId}>
                                    {columns.map((column) => (
                                        <TableCell key={column.id} align={column.align}>
                                            {column.id === 'actions' ? (
                                                <>
                                                    <IconButton onClick={() => handleEdit(row.highestQualificationId)} style={{ color: '#00afb5' }}>
                                                        <Edit />
                                                    </IconButton>
                                                    <IconButton onClick={() => handleDelete(row.highestQualificationId)} color="error">
                                                        <DeleteForever />
                                                    </IconButton>
                                                </>
                                            ) : column.id === 'isActive' ? (
                                            ...
                                            ) : column.id === 'highestQualificationDescription' ? (
                                                <Box
                                                    sx={{
                                                        maxWidth: 200,
                                                        overflow: 'hidden',
                ...
                title={
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                            <span>Highest Qualification Management</span>
