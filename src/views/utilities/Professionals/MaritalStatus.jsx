                            ...
                            <TableRow>
                                <TableCell colSpan={columns.length} align="center">
                                    <Box sx={{ py: 2 }}>
                                        ...
                                        <div style={{ fontSize: '12px', color: 'gray' }}>Marital statuses array length: {maritalStatuses.length}</div>
                                    </Box>
                                </TableCell>
                            </TableRow>
                        ) : (
                                ...
                                <TableRow hover role="checkbox" tabIndex={-1} key={row.maritalStatusId}>
                                    {columns.map((column) => (
                                        <TableCell key={column.id} align={column.align}>
                                            {column.id === 'actions' ? (
                                                <>
                                                    <IconButton onClick={() => handleEdit(row.maritalStatusId)} style={{ color: '#00afb5' }}>
                                                        <Edit />
                                                    </IconButton>
                                                    <IconButton onClick={() => handleDelete(row.maritalStatusId)} color="error">
                                                        <DeleteForever />
                                                    </IconButton>
                                                </>
                                            ) : column.id === 'isActive' ? (
                                            ...
                                            ) : column.id === 'maritalStatusDescription' ? (
                                                <Box
                                                    sx={{
                                                        maxWidth: 200,
                                                        overflow: 'hidden',
                ...
                title={
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                            <span>Marital Status Management</span>
