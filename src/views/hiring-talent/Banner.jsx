                ...
                <Grid container direction="column" sx={{ width: '100%', height: '100%' }}>
                    <Grid item xs={12} sx={{ width: '100%', height: '100%' }}>
                        {loading ? (
                            ...
                            <Box sx={{ position: 'relative', width: '100%', maxWidth: '100%', height: { xs: 180, sm: 250, md: 300 }, overflow: 'hidden' }}>
                                <Carousel
                                    showThumbs={false}
                                    showArrows={!isMobile}
                                    showIndicators={true}
                                    ...
                                    style={{ width: '100%', maxWidth: '100%', height: bannerHeight }}
                                >
                                    {advertisement.length > 0 ? (
                                        advertisement.map((ad) =>
                                            ad.filePath ? (
                                                <div key={ad.advertisementId} style={{ width: '100%', maxWidth: '100%', height: bannerHeight, overflow: 'hidden' }}>
